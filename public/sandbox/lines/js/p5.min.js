/*! p5.js v0.4.5 May 27, 2015 */ !(function(a, b) {
  ...
  return (
    ...
    (amdclean.core = (function(a, b, c) {
          ...
          2 === arguments.length &&
            ...
            (this._start = function() {
              if (
                ...
                (this._loadingScreen = document.getElementById(
              ...
              b
                ? (this._preloadMethods.forEach(function(a) {
                    c[a] = function() {
            ...
            (this._setup = function() {
              ...
              "function" == typeof a.preload &&
                this._preloadMethods.forEach(function(b) {
                  a[b] = d.prototype[b];
                }),
            ...
            (this._draw = function() {
              ...
              (this._frameRate = 1e3 / (a - this._lastFrameTime)),
                ...
                this._loop &&
                  (this._drawInterval && clearInterval(this._drawInterval),
            ...
            (this.remove = function() {
              if (this._curElement) {
                (this._loop = !1),
                  this._drawInterval && clearTimeout(this._drawInterval),
                ...
                for (var b = 0; b < this._elements.length; b++) {
                  ...
                  for (var e in c._events)
                    c.elt.removeEventListener(e, c._events[e]);
                }
                var f = this;
                if (
            ...
            for (var g in d.prototype)
              if ("function" == typeof d.prototype[g]) {
                ...
                this._events.hasOwnProperty(h) ||
                  (window[g] = d.prototype[g].bind(this));
      ...
      return (
        ...
        (d.prototype._registeredMethods = { pre: [], post: [], remove: [] }),
        (d.prototype.registerPreloadMethod = function(a) {
          d.prototype._preloadMethods.push(a);
        }.bind(this)),
        (d.prototype.registerMethod = function(a, b) {
          d.prototype._registeredMethods.hasOwnProperty(a) ||
            (d.prototype._registeredMethods[a] = []),
            d.prototype._registeredMethods[a].push(b);
        }.bind(this)),
        d
      );
    })({}, amdclean.shim, amdclean.constants)),
    (amdclean.utilscolor_utils = (function(a, b) {
      var c = b;
      return (
        (c.ColorUtils = {}),
        (c.ColorUtils.hsbaToRGBA = function(a) {
          var b = a[0],
            c = a[1],
            d = a[2];
          (b /= 255), (c /= 255), (d /= 255);
    ...
    (amdclean.p5Color = (function(a, b, c, d) {
      var e = b,
        f = c,
        d = d;
      (e.Color = function(a, b) {
        return (
          (this.color_array = e.Color._getFormattedColor.apply(a, b)),
          this._normalizeColorArray(a),
          a._colorMode === d.HSB
            ? ((this.hsba = this.color_array),
              (this.rgba = f.hsbaToRGBA(this.hsba)))
            : ((this.rgba = this.color_array),
              (this.hsba = f.rgbaToHSBA(this.rgba))),
          this
        );
      }),
      ...
      var g = /\s*/,
        ...
        l = {
          ...
          RGB: new RegExp(
            ["^rgb\\(", h.source, ",", h.source, ",", h.source, "\\)$"].join(
              g.source
            ),
            "i"
          ),
          RGB_PERCENT: new RegExp(
            ["^rgb\\(", j.source, ",", j.source, ",", j.source, "\\)$"].join(
              g.source
            ),
            "i"
          ),
        ...
        (e.Color._getFormattedColor = function() {
          ...
          if (arguments.length >= 3)
            (a = arguments[0]),
              (b = arguments[1]),
              (c = arguments[2]),
              (f = "number" == typeof arguments[3] ? arguments[3] : 255);
          else {
            if ("string" == typeof arguments[0])
              return (
                (g = arguments[0].trim().toLowerCase()),
                k[g]
                  ...
                  : ((h = l.HEX3.test(g)
                      ...
                      : l.RGB_PERCENT.test(g)
                      ? l.RGB_PERCENT.exec(g)
                          .slice(1)
                          .map(function(a) {
                            return parseInt((parseFloat(a) / 100) * 255, 10);
                          })
                      : l.RGBA.test(g)
                      ? l.RGBA.exec(g)
                          .slice(1)
                          .map(function(a, b) {
                            return 3 === b
                              ? parseInt(255 * parseFloat(a), 10)
                              : parseInt(a, 10);
                          })
                      : l.RGBA_PERCENT.test(g)
                      ? l.RGBA_PERCENT.exec(g)
                          .slice(1)
                          .map(function(a, b) {
                            return 3 === b
                              ? parseInt(255 * parseFloat(a), 10)
                              : parseInt((parseFloat(a) / 100) * 255, 10);
                          })
                      : [255]),
                    e.Color._getFormattedColor.apply(this, h))
              );
            this._colorMode === d.RGB
              ? (a = b = c = arguments[0])
              : ((a = c = arguments[0]), (b = 0)),
              (f = "number" == typeof arguments[1] ? arguments[1] : 255);
          }
          return [a, b, c, f];
        }),
        e.Color
    ...
    (amdclean.p5Element = (function(a, b) {
      function c(a, b, c) {
        var d = b.bind(c);
          ...
          return (
            window.File && window.FileReader && window.FileList && window.Blob
              ? (c(
                ...
                arguments.length > 1 && c("drop", b, this),
                c(
                  "drop",
                  function(a) {
                    a.stopPropagation(), a.preventDefault();
                    for (
                      var b = a.dataTransfer.files, c = 0;
                      c < b.length;
                      c++
                    ) {
                      var d = b[c],
    ...
    (amdclean.p5Graphics = (function(a, b, c) {
      var d = b,
        c = c;
      return (
        (d.Graphics = function(a, b, c) {
          d.Element.call(this, a, b),
            (this.canvas = a),
        ...
        (d.Graphics.prototype._applyDefaults = function() {
    ...
    (amdclean.filters = (function() {
      ...
      (c._toPixels = function(a) {
        ...
        (c._createImageData = function(a, b) {
          return (
            (c._tmpCanvas = document.createElement("canvas")),
            (c._tmpCtx = c._tmpCanvas.getContext("2d")),
    ...
    (amdclean.polargeometry = (function() {
      return {
    ...
    (amdclean.p5Vector = (function(a, b, c, d) {
      ...
      return (
        ...
        (e.Vector.prototype.copy = function() {
          return this.p5
            ? new e.Vector(this.p5, [this.x, this.y, this.z])
            : new e.Vector(this.x, this.y, this.z);
        }),
        ...
        (e.Vector.prototype.mult = function(a) {
          return (
            (this.x *= a || 0), (this.y *= a || 0), (this.z *= a || 0), this
          );
        }),
        ...
        (e.Vector.prototype.heading = function() {
          ...
          return this.p5
            ? this.p5._angleMode === d.RADIANS
              ? a
              : f.radiansToDegrees(a)
            : a;
        }),
        (e.Vector.prototype.rotate = function(a) {
          this.p5 &&
            this.p5._angleMode === d.DEGREES &&
        ...
        (e.Vector.prototype.equals = function(a, b, c) {
          return (
            a instanceof e.Vector
              ? ((a = a.x || 0), (b = a.y || 0), (c = a.z || 0))
              : a instanceof Array
              ? ((a = a[0] || 0), (b = a[1] || 0), (c = a[2] || 0))
              : ((a = a || 0), (b = b || 0), (c = c || 0)),
        ...
        (e.Vector.fromAngle = function(a) {
          return (
            this.p5 &&
              ...
              (a = f.degreesToRadians(a)),
            this.p5
              ? new e.Vector(this.p5, [Math.cos(a), Math.sin(a), 0])
              : new e.Vector(Math.cos(a), Math.sin(a), 0)
          );
        }),
        (e.Vector.random2D = function() {
          ...
          return (
            (a = this.p5
              ? this.p5.random(
                  this.p5._angleMode === d.DEGREES ? 360 : d.TWO_PI
                )
        ...
        (e.Vector.random3D = function() {
          var a, b;
          this.p5
            ? ((a = this.p5.random(0, d.TWO_PI)), (b = this.p5.random(-1, 1)))
            : ((a = Math.random() * Math.PI * 2), (b = 2 * Math.random() - 1));
          var c = Math.sqrt(1 - b * b) * Math.cos(a),
            f = Math.sqrt(1 - b * b) * Math.sin(a);
          return this.p5
            ? new e.Vector(this.p5, [c, f, b])
            : new e.Vector(c, f, b);
        }),
    ...
    (amdclean.p5TableRow = (function(a, b) {
      "use strict";
      var c = b;
      return (
        (c.TableRow = function(a, b) {
          var c = [],
            d = {};
          a && ((b = b || ","), (c = a.split(b)));
        ...
        (c.TableRow.prototype.getNum = function(a) {
          ...
          if (
            ((b =
              "string" == typeof a
                ? parseFloat(this.obj[a], 10)
                : parseFloat(this.arr[a], 10)),
            "NaN" === b.toString())
          )
    ...
    (amdclean.p5Table = (function(a, b) {
      ...
      return (
        ...
        (c.Table.prototype.removeColumn = function(a) {
          var b, c;
          "string" == typeof a
            ? ((b = a), (c = this.columns.indexOf(a)), console.log("string"))
        ...
        (c.Table.prototype.set = function(a, b, c) {
          this.rows[a].set(b, c);
        }),
        (c.Table.prototype.setNum = function(a, b, c) {
          this.rows[a].set(b, c);
        }),
        (c.Table.prototype.setString = function(a, b, c) {
          this.rows[a].set(b, c);
        }),
        (c.Table.prototype.get = function(a, b) {
          return this.rows[a].get(b);
        }),
        (c.Table.prototype.getNum = function(a, b) {
          return this.rows[a].getNum(b);
        }),
        (c.Table.prototype.getString = function(a, b) {
          return this.rows[a].getString(b);
        }),
        c.Table
      );
    })({}, amdclean.core)),
    (amdclean.colorcreating_reading = (function(a, b) {
      "use strict";
      var c = b;
      return (
        (c.prototype.alpha = function(a) {
          if (a instanceof c.Color || a instanceof Array)
            return this.color(a).getAlpha();
          throw new Error("Needs p5.Color or pixel array as argument.");
        }),
        (c.prototype.blue = function(a) {
          if (a instanceof c.Color || a instanceof Array)
            return this.color(a).getBlue();
          throw new Error("Needs p5.Color or pixel array as argument.");
        }),
        ...
        (c.prototype.color = function() {
          ...
          if (arguments[0] instanceof Array)
            return new c.Color(this, arguments[0]);
          var a = Array.prototype.slice.call(arguments);
          return new c.Color(this, a);
        }),
        (c.prototype.green = function(a) {
          if (a instanceof c.Color || a instanceof Array)
            return this.color(a).getGreen();
          throw new Error("Needs p5.Color or pixel array as argument.");
        }),
        ...
        (c.prototype.lerpColor = function(a, b, d) {
          if (((d = Math.max(Math.min(d, 1), 0)), a instanceof Array)) {
            for (var e = [], f = 0; f < a.length; f++)
              e.push(Math.sqrt(c.prototype.lerp(a[f] * a[f], b[f] * b[f], d)));
            return e;
          }
          if (a instanceof c.Color) {
            for (var g = [], h = 0; 4 > h; h++)
          ...
          return Math.sqrt(c.prototype.lerp(a * a, b * b, d));
        }),
        (c.prototype.red = function(a) {
          if (a instanceof c.Color || a instanceof Array)
            return this.color(a).getRed();
          throw new Error("Needs p5.Color or pixel array as argument.");
        }),
    ...
    (amdclean.colorsetting = (function(a, b, c) {
      "use strict";
      var d = b,
        c = c;
      return (
        (d.prototype._doStroke = !0),
        (d.prototype._doFill = !0),
        (d.prototype._colorMode = c.RGB),
        (d.prototype._maxRGB = [255, 255, 255, 255]),
        (d.prototype._maxHSB = [255, 255, 255, 255]),
          ...
          if (arguments[0] === c.RGB || arguments[0] === c.HSB) {
            ...
            2 === arguments.length
              ...
              : arguments.length > 2 &&
                ...
                (b[1] = arguments[2]),
                (b[2] = arguments[3])),
              5 === arguments.length && (b[3] = arguments[4]);
          }
        }),
    ...
    (amdclean.dataconversion = (function(a, b) {
      "use strict";
      var c = b;
      return (
        (c.prototype["float"] = function(a) {
          return parseFloat(a);
        }),
        (c.prototype["int"] = function(a, b) {
          return "string" == typeof a
            ...
            : a instanceof Array
            ? a.map(function(a) {
                return c.prototype["int"](a, b);
              })
            : void 0;
        }),
        (c.prototype.str = function(a) {
          return a instanceof Array ? a.map(c.prototype.str) : String(a);
        }),
        (c.prototype["boolean"] = function(a) {
          return "number" == typeof a
            ...
            ? a
            : a instanceof Array
            ? a.map(c.prototype["boolean"])
            : void 0;
        }),
        (c.prototype["byte"] = function(a) {
          var b = c.prototype["int"](a, 10);
          return "number" == typeof b
            ? ((b + 128) % 256) - 128
            : b instanceof Array
            ? b.map(c.prototype["byte"])
            : void 0;
        }),
        (c.prototype["char"] = function(a) {
          return "number" != typeof a || isNaN(a)
            ? a instanceof Array
              ? a.map(c.prototype["char"])
              : "string" == typeof a
              ? c.prototype["char"](parseInt(a, 10))
              : void 0
            : String.fromCharCode(a);
        }),
        (c.prototype.unchar = function(a) {
          return "string" == typeof a && 1 === a.length
            ? a.charCodeAt(0)
            : a instanceof Array
            ? a.map(c.prototype.unchar)
            : void 0;
        }),
        (c.prototype.hex = function(a, b) {
          if (
            ((b = void 0 === b || null === b ? (b = 8) : b), a instanceof Array)
          )
            return a.map(function(a) {
              return c.prototype.hex(a, b);
            });
          if ("number" == typeof a) {
            ...
            for (
              ...
              d = "0" + d;
            return (
              d.length >= b && (d = d.substring(d.length - b, d.length)), d
            );
          }
        }),
        (c.prototype.unhex = function(a) {
          return a instanceof Array
            ? a.map(c.prototype.unhex)
            : parseInt("0x" + a, 16);
        }),
        c
      );
    })({}, amdclean.core)),
    (amdclean.dataarray_functions = (function(a, b) {
      "use strict";
      var c = b;
      return (
        ...
        (c.prototype.shuffle = function(a, b) {
          a = b || ArrayBuffer.isView(a) ? a : a.slice();
          for (var c, d, e = a.length; e > 1; )
            (c = (Math.random() * e) | 0),
              (d = a[--e]),
              (a[e] = a[c]),
              (a[c] = d);
    ...
    (amdclean.datastring_functions = (function(a, b) {
      "use strict";
      function c() {
        var a = arguments[0],
          b = 0 > a,
      ...
      function d() {
        ...
        return (
          ...
          0 === arguments[1] && (c = ""),
          arguments.length > 1 && (c = c.substring(0, arguments[1] + 1)),
          d + c
        );
      }
      function e() {
    ...
    (amdclean.environment = (function(a, b, c) {
      "use strict";
      function d(a) {
        var b =
      ...
      return (
        (f.prototype._frameRate = 0),
        (f.prototype._lastFrameTime = new Date().getTime()),
        (f.prototype._targetFrameRate = 60),
        (f.prototype.frameCount = 0),
        (f.prototype.focused = !0),
        (f.prototype.cursor = function(a, b, c) {
          var d = "auto",
        ...
        (f.prototype.displayWidth = screen.width),
        (f.prototype.displayHeight = screen.height),
        (f.prototype.windowWidth = window.innerWidth),
        (f.prototype.windowHeight = window.innerHeight),
        (f.prototype._onresize = function(a) {
          this._setProperty("windowWidth", window.innerWidth),
            this._setProperty("windowHeight", window.innerHeight);
          var b,
            c = this._isGlobal ? window : this;
          "function" == typeof c.windowResized &&
            ((b = c.windowResized(a)), void 0 === b || b || a.preventDefault());
        }),
        (f.prototype.width = 0),
        (f.prototype.height = 0),
        (f.prototype.fullscreen = function(a) {
          return "undefined" == typeof a
            ? document.fullscreenElement ||
                document.webkitFullscreenElement ||
                document.mozFullScreenElement ||
                document.msFullscreenElement
            : void (a ? d(document.documentElement) : e());
        }),
    ...
    (amdclean.imageimage = (function(a, b, c) {
      "use strict";
      var d = b,
        c = c;
      return (
        (d.prototype._imageMode = c.CORNER),
        (d.prototype._tint = null),
      ...
      return {
        modeAdjust: function(a, c, d, e, f) {
          return f === b.CORNER
            ...
            ? { x: a, y: c, w: d - a, h: e - c }
            : f === b.RADIUS
            ? { x: a - d, y: c - e, w: 2 * d, h: 2 * e }
            : f === b.CENTER
            ? { x: a - 0.5 * d, y: c - 0.5 * e, w: d, h: e }
            : void 0;
        },
    ...
    (amdclean.imageloading_displaying = (function(a, b, c, d, e) {
      "use strict";
      var f = b,
        g = c,
        d = d,
        e = e;
      return (
        (f.prototype.loadImage = function(a, b, c) {
          var d = new Image(),
            e = new f.Image(1, 1, this);
          return (
            (d.onload = function() {
              (e.width = e.canvas.width = d.width),
                (e.height = e.canvas.height = d.height),
                e.canvas.getContext("2d").drawImage(d, 0, 0),
          ...
          try {
            this._tint && a.canvas
              ? this.drawingContext.drawImage(
                  this._getTintedImageCanvas(a),
                  h.x,
                  h.y,
                  h.w,
                  h.h
                )
              : this.drawingContext.drawImage(g, h.x, h.y, h.w, h.h);
          } catch (i) {
        ...
        (f.prototype.imageMode = function(a) {
          (a === e.CORNER || a === e.CORNERS || a === e.CENTER) &&
            (this._imageMode = a);
        }),
        f
      );
    ...
    (amdclean.imagepixels = (function(a, b, c) {
      "use strict";
      var d = b,
        e = c;
      return (
        ...
        (d.prototype.get = function(a, b, c, e) {
          if (
            ...
            a > this.width || b > this.height || 0 > a || 0 > b)
          )
            return [0, 0, 0, 255];
          var f = this.drawingContext.getImageData(a, b, c, e),
            g = f.data;
          if (1 === c && 1 === e) {
            for (var h = [], i = 0; i < g.length; i += 4)
              h.push(g[i], g[i + 1], g[i + 2], g[i + 3]);
            return h;
          }
        ...
        (d.prototype.loadPixels = function() {
          ...
          this._setProperty("imageData", c),
            this._setProperty("pixels", c.data);
        }),
        (d.prototype.set = function(a, b, c) {
          if (c instanceof d.Image)
            ...
            if (
              (this.imageData || this.loadPixels.call(this),
              "number" == typeof c)
            )
              ...
              c instanceof d.Color &&
                e < this.pixels.length &&
                ((this.pixels[e] = c.rgba[0]),
                (this.pixels[e + 1] = c.rgba[1]),
                (this.pixels[e + 2] = c.rgba[2]),
                (this.pixels[e + 3] = c.rgba[3]));
          }
        }),
    ...
    !(function(a, b, c) {
      ...
      function succeed(a) {
        ...
        return (
          (b = (b && b[1]) || window.location.protocol),
          httpsRe.test(b)
            ? twoHundo.test(a.request.status)
            : !!a.request.response
        );
      }
      function handleReadyState(a, b, c) {
        return function() {
          return a._aborted
            ? c(a.request)
            : a._timedOut
            ? c(a.request, "Request is aborted: timeout")
            : void (
                a.request &&
                4 == a.request[readyState] &&
      ...
      function setHeaders(a, b) {
        ...
        d.Accept =
          d.Accept ||
          defaultHeaders.accept[b.type] ||
          defaultHeaders.accept["*"];
        var e = "function" == typeof FormData && b.data instanceof FormData;
        b.crossOrigin ||
          d[requestedWith] ||
          (d[requestedWith] = defaultHeaders.requestedWith),
          d[contentType] ||
            e ||
            (d[contentType] = b.contentType || defaultHeaders.contentType);
        for (c in d)
          d.hasOwnProperty(c) &&
            "setRequestHeader" in a &&
            a.setRequestHeader(c, d[c]);
      }
      function setCredentials(a, b) {
        "undefined" != typeof b.withCredentials &&
      ...
      function handleJsonp(a, b, c, d) {
        ...
        return (
          ...
          (j.src = d),
          (j.async = !0),
          "undefined" == typeof j.onreadystatechange ||
            l ||
      ...
      function getRequest(a, b) {
        var c,
          ...
          g =
            d.processData !== !1 && d.data && "string" != typeof d.data
              ? reqwest.toQueryString(d.data)
              : d.data || null,
          h = !1;
        return (
          ("jsonp" != d.type && "GET" != e) ||
            !g ||
            ((f = urlappend(f, g)), (g = null)),
          "jsonp" == d.type
            ? handleJsonp(d, a, b, f)
            : ((c = (d.xhr && d.xhr(d)) || xhr(d)),
              c.open(e, f, d.async === !1 ? !1 : !0),
              setHeaders(c, d),
              setCredentials(c, d),
              win[xDomainRequest] && c instanceof win[xDomainRequest]
                ? ((c.onload = a),
                  (c.onerror = b),
                  (c.onprogress = function() {}),
                  (h = !0))
                : (c.onreadystatechange = handleReadyState(this, a, b)),
              d.before && d.before(c),
              h
                ? setTimeout(function() {
                    c.send(g);
          ...
          i = function(a) {
            a &&
              ...
              b(
                g,
                normalize(
                  a.attributes.value && a.attributes.value.specified
                    ? a.value
                    : a.text
                )
              );
          ...
          switch (h) {
            case "input":
              /reset|button|image|file/i.test(a.type) ||
                ((c = /checkbox/i.test(a.type)),
                (d = /radio/i.test(a.type)),
                (e = a.value),
                (!(c || d) || a.checked) &&
                  b(g, normalize(c && "" === e ? "on" : e)));
              break;
            case "textarea":
      ...
      function serializeHash() {
        ...
        return (
          eachFormElement.apply(function(b, c) {
            b in a
              ? (a[b] && !isArray(a[b]) && (a[b] = [a[b]]), a[b].push(c))
              : (a[b] = c);
          }, arguments),
          a
        );
      ...
      return (
        (Reqwest.prototype = {
          ...
          then: function(a, b) {
            return (
              ...
              (b = b || function() {}),
              this._fulfilled
                ? (this._responseArgs.resp = a(this._responseArgs.resp))
                : this._erred
                ? b(
        ...
        (reqwest.toQueryString = function(a, b) {
          ...
          else for (c in a) a.hasOwnProperty(c) && buildParams(c, a[c], e, h);
        ...
        (reqwest.compat = function(a, b) {
          return (
            a &&
              ...
              a.jsonpCallback &&
                (a.jsonpCallbackName = a.jsonpCallback) &&
    ...
    (amdclean.inputfiles = (function(a, b, c) {
      ...
      return (
        ...
        (e.prototype.loadJSON = function() {
          ...
          return (
            "string" == typeof arguments[2] &&
              ("jsonp" === arguments[2] || "json" === arguments[2]) &&
              (e = arguments[2]),
            c({ url: a, type: e, crossOrigin: !0 }).then(function(a) {
        ...
        (e.prototype.loadTable = function(a) {
          for (
            var b = null, f = [], g = !1, h = ",", i = !1, j = 1;
            j < arguments.length;
            j++
          )
            if ("function" == typeof arguments[j]) b = arguments[j];
            else if ("string" == typeof arguments[j])
              if (
                (f.push(arguments[j]),
                "header" === arguments[j] && (g = !0),
                "csv" === arguments[j])
              ) {
                if (i) throw new Error("Cannot set multiple separator types.");
                (h = ","), (i = !0);
              } else if ("tsv" === arguments[j]) {
                if (i) throw new Error("Cannot set multiple separator types.");
                (h = "	"), (i = !0);
              }
          var k = new e.Table();
          return (
            c({ url: a, crossOrigin: !0, type: "csv" })
              .then(function(a) {
                a = a.responseText;
                for (
                  var c,
                    ...
                    v = function() {
                      (f.currentState = n), r.push(t), (t = null);
                    },
                    w = function() {
                      (f.currentState = i), (f.token = "");
                    },
                    x = function() {
                      t.push(f.token), w();
                    };
                  ...
                  if (((c = a[s++]), null == c)) {
                    if (f.escaped) throw new Error("Unclosed quote in file.");
                    if (t) {
                      x(), v();
                      break;
                    }
                  }
                  if ((null === t && u(), f.currentState === i)) {
                    if (c === o) {
                      (f.escaped = !0), (f.currentState = l);
                      continue;
                    }
                    f.currentState = l;
                  }
                  f.currentState === l && f.escaped
                    ? c === o
                      ? a[s] === o
                        ? ((f.token += o), s++)
                        : ((f.escaped = !1), (f.currentState = m))
                      : (f.token += c)
                    : c === p
                    ? (a[s] === q && s++, x(), v())
                    : c === q
                    ...
                    : c === h
                    ? x()
                    : f.currentState === l && (f.token += c);
                }
                if (g) k.columns = r.shift();
                else for (j = 0; j < r.length; j++) k.columns[j] = j.toString();
                var y;
                for (j = 0; j < r.length; j++)
                  (y = new e.TableRow()),
                    (y.arr = r[j]),
                    (y.obj = d(r[j], k.columns)),
                    k.addRow(y);
                null !== b && b(k);
              })
              .fail(function() {
        ...
        (e.prototype.loadXML = function(a, b) {
          var d = [];
          return (
            c({ url: a, type: "xml", crossOrigin: !0 }).then(function(a) {
              b(a);
            }),
            d
          );
        ...
        (e.prototype.httpDo = function() {
          for (
            var a, b = "GET", d = arguments[0], e = {}, f = "", g = 1;
            g < arguments.length;
            g++
          ) {
            var h = arguments[g];
    ...
    (amdclean.inputkeyboard = (function(a, b) {
      "use strict";
      var c = b,
        d = {};
      return (
        (c.prototype.isKeyPressed = !1),
        (c.prototype.keyIsPressed = !1),
        (c.prototype.key = ""),
        (c.prototype.keyCode = 0),
    ...
    (amdclean.inputacceleration = (function(a, b) {
      "use strict";
      var c = b;
      (c.prototype.deviceOrientation = void 0),
        (c.prototype.accelerationX = 0),
        (c.prototype.accelerationY = 0),
        (c.prototype.accelerationZ = 0),
        (c.prototype.pAccelerationX = 0),
        (c.prototype.pAccelerationY = 0),
        (c.prototype.pAccelerationZ = 0),
        (c.prototype._updatePAccelerations = function() {
          this._setProperty("pAccelerationX", this.accelerationX),
            this._setProperty("pAccelerationY", this.accelerationY),
            this._setProperty("pAccelerationZ", this.accelerationZ);
        });
      var d = 0.5;
      c.prototype.setMoveThreshold = function(a) {
        "number" == typeof a && (d = a);
      };
      var e = "",
        f = "";
      return (
        (c.prototype._ondeviceorientation = function(a) {
          this._setProperty("accelerationX", a.beta),
            this._setProperty("accelerationY", a.gamma),
            this._setProperty("accelerationZ", a.alpha),
            this._handleMotion();
        }),
        (c.prototype._ondevicemotion = function(a) {
        ...
        (c.prototype._onMozOrientation = function(a) {
          this._setProperty("accelerationX", a.x),
            this._setProperty("accelerationY", a.y),
            this._setProperty("accelerationZ", a.z),
            this._handleMotion();
        }),
        (c.prototype._handleMotion = function() {
          ...
          var a = this.onDeviceMove || window.onDeviceMove;
          "function" == typeof a &&
            ...
            a();
          var b = this.onDeviceTurn || window.onDeviceTurn;
          if ("function" == typeof b) {
            var c = 0;
            Math.abs(this.accelerationX) > c &&
              ((c = this.accelerationX), (f = "x")),
              Math.abs(this.accelerationY) > c &&
                ((c = this.accelerationY), (f = "y")),
              Math.abs(this.accelerationZ) > c && (f = "z"),
              "" !== e && e !== f && b(f),
              (e = f);
          }
        }),
    ...
    (amdclean.inputmouse = (function(a, b, c) {
      "use strict";
      function d(a, b) {
      ...
      return (
        ...
        (e.prototype._updateMouseCoords = function(a) {
          if (
            "touchstart" === a.type ||
            "touchmove" === a.type ||
            "touchend" === a.type
          ...
          this._setProperty("winMouseX", a.pageX),
            this._setProperty("winMouseY", a.pageY);
        }),
        ...
        (e.prototype._setMouseButton = function(a) {
          1 === a.button
            ? this._setProperty("mouseButton", c.CENTER)
            : 2 === a.button
            ? this._setProperty("mouseButton", c.RIGHT)
            : (this._setProperty("mouseButton", c.LEFT),
        ...
        (e.prototype._onmousemove = function(a) {
          var b,
            c = this._isGlobal ? window : this;
          this._updateMouseCoords(a),
            this.isMousePressed
              ? "function" == typeof c.mouseDragged
                ? ((b = c.mouseDragged(a)), b === !1 && a.preventDefault())
                : "function" == typeof c.touchMoved &&
                  ((b = c.touchMoved(a)),
                  b === !1 && a.preventDefault(),
                  this._updateTouchCoords(a))
              : "function" == typeof c.mouseMoved &&
                ((b = c.mouseMoved(a)), b === !1 && a.preventDefault());
        }),
        (e.prototype._onmousedown = function(a) {
          ...
          this._setProperty("isMousePressed", !0),
            ...
            this._updateMouseCoords(a),
            "function" == typeof c.mousePressed
              ? ((b = c.mousePressed(a)), b === !1 && a.preventDefault())
        ...
        (e.prototype._onmouseup = function(a) {
          ...
          this._setProperty("isMousePressed", !1),
            ...
            "function" == typeof c.mouseReleased
              ? ((b = c.mouseReleased(a)), b === !1 && a.preventDefault())
              : "function" == typeof c.touchEnded &&
                ((b = c.touchEnded(a)),
                b === !1 && a.preventDefault(),
                this._updateTouchCoords(a));
        }),
        ...
        (e.prototype._onmousewheel = e.prototype._onDOMMouseScroll = function(
          a
        ) {
          var b = this._isGlobal ? window : this;
    ...
    (amdclean.inputtime_date = (function(a, b) {
      "use strict";
      var c = b;
      return (
        (c.prototype.day = function() {
    ...
    (amdclean.inputtouch = (function(a, b) {
      "use strict";
      function c(a, b, c) {
        c = c || 0;
      ...
      var d = b;
      return (
        (d.prototype.touchX = 0),
        (d.prototype.touchY = 0),
        (d.prototype.ptouchX = 0),
        (d.prototype.ptouchY = 0),
        (d.prototype.touches = []),
        (d.prototype.touchIsDown = !1),
        (d.prototype._updateTouchCoords = function(a) {
          if (
            "mousedown" === a.type ||
            "mousemove" === a.type ||
            "mouseup" === a.type
        ...
        (d.prototype._ontouchstart = function(a) {
          ...
          this._updateTouchCoords(a),
            ...
            "function" == typeof c.touchStarted
              ? ((b = c.touchStarted(a)), b === !1 && a.preventDefault())
              : "function" == typeof c.mousePressed &&
                ((b = c.mousePressed(a)), b === !1 && a.preventDefault());
        }),
        (d.prototype._ontouchmove = function(a) {
          ...
          this._updateTouchCoords(a),
            "function" == typeof c.touchMoved
              ? ((b = c.touchMoved(a)), b === !1 && a.preventDefault())
              : "function" == typeof c.mouseDragged &&
                ((b = c.mouseDragged(a)),
                b === !1 && a.preventDefault(),
                this._updateMouseCoords(a));
        ...
        (d.prototype._ontouchend = function(a) {
          ...
          var b,
            c = this._isGlobal ? window : this;
          "function" == typeof c.touchEnded
            ? ((b = c.touchEnded(a)), b === !1 && a.preventDefault())
            : "function" == typeof c.mouseReleased &&
              ((b = c.mouseReleased(a)),
              b === !1 && a.preventDefault(),
              this._updateMouseCoords(a));
    ...
    (amdclean.mathmath = (function(a, b) {
      "use strict";
      var c = b;
      return (
        (c.prototype.createVector = function(a, b, d) {
          return this instanceof c
            ? new c.Vector(this, arguments)
            : new c.Vector(a, b, d);
        }),
        c
      );
    })({}, amdclean.core)),
    (amdclean.mathcalculation = (function(a, b) {
      "use strict";
      var c = b;
      return (
        (c.prototype.abs = Math.abs),
        (c.prototype.ceil = Math.ceil),
        (c.prototype.constrain = function(a, b, c) {
          return Math.max(Math.min(a, c), b);
        }),
        (c.prototype.dist = function(a, b, c, d) {
          return Math.sqrt((c - a) * (c - a) + (d - b) * (d - b));
        }),
        (c.prototype.exp = Math.exp),
        (c.prototype.floor = Math.floor),
        (c.prototype.lerp = function(a, b, c) {
          return c * (b - a) + a;
        }),
        (c.prototype.log = Math.log),
        (c.prototype.mag = function(a, b) {
        ...
        (c.prototype.pow = Math.pow),
        (c.prototype.round = Math.round),
        (c.prototype.sq = function(a) {
          return a * a;
        }),
        (c.prototype.sqrt = Math.sqrt),
        c
      );
    })({}, amdclean.core)),
    (amdclean.mathrandom = (function(a, b) {
      "use strict";
      var c = b,
        d = !1,
        e = (function() {
      ...
      (c.prototype.randomSeed = function(a) {
        ...
        (c.prototype.random = function(a, b) {
          var c;
          if (((c = d ? e.rand() : Math.random()), 0 === arguments.length))
            return c;
      ...
      var f,
        g = !1;
      return (
        (c.prototype.randomGaussian = function(a, b) {
          var c, d, e, h;
          if (g) (c = f), (g = !1);
          else {
            do
    ...
    (amdclean.mathnoise = (function(a, b) {
      "use strict";
      for (
        var c = b,
          d = 4,
        ...
        (m[p] = Math.sin(p * o * k)), (n[p] = Math.cos(p * o * k));
      var q = l;
      q >>= 1;
      var r;
      return (
        (c.prototype.noise = function(a, b, c) {
          ...
          for (
            var m,
              ...
              B = 0.5,
              C = function(a) {
                return 0.5 * (1 - n[Math.floor(a * q) % l]);
              },
              D = 0;
            i > D;
            D++
    ...
    (amdclean.mathtrigonometry = (function(a, b, c, d) {
      "use strict";
      var e = b,
        f = c,
        d = d;
      return (
        (e.prototype._angleMode = d.RADIANS),
        (e.prototype.acos = function(a) {
          return this._angleMode === d.RADIANS
            ? Math.acos(a)
            : f.radiansToDegrees(Math.acos(a));
        }),
        (e.prototype.asin = function(a) {
          return this._angleMode === d.RADIANS
            ? Math.asin(a)
            : f.radiansToDegrees(Math.asin(a));
        }),
        (e.prototype.atan = function(a) {
          return this._angleMode === d.RADIANS
            ? Math.atan(a)
            : f.radiansToDegrees(Math.atan(a));
        }),
        (e.prototype.atan2 = function(a, b) {
          return this._angleMode === d.RADIANS
            ? Math.atan2(a, b)
            : f.radiansToDegrees(Math.atan2(a, b));
        }),
    ...
    (amdclean.outputfiles = (function(a, b) {
      "use strict";
      function c(a, b) {
      ...
      (window.URL = window.URL || window.webkitURL),
        (e.prototype._pWriters = []),
        (e.prototype.beginRaw = function() {
          throw "not yet implemented";
        }),
        ...
        (e.prototype.createWriter = function(a, b) {
          ...
          for (var d in e.prototype._pWriters)
            if (e.prototype._pWriters[d].name === a)
              return (
                (c = new e.PrintWriter(a + window.millis(), b)),
                e.prototype._pWriters.push(c),
                c
              );
          return (
            (c = new e.PrintWriter(a, b)), e.prototype._pWriters.push(c), c
          );
        }),
        ...
        (e.PrintWriter = function(a, b) {
          ...
          (this.name = a),
            ...
            (this.close = function() {
              ...
              for (var f in e.prototype._pWriters)
                e.prototype._pWriters[f].name === this.name &&
                  e.prototype._pWriters.splice(f, 1);
              c.flush(), (c = {});
            });
        }),
        ...
        (e.prototype.save = function() {
          ...
          if (a[0] instanceof e.Graphics)
            return void e.prototype.saveCanvas(a[0].elt, a[1], a[2]);
          if (1 === a.length && "string" == typeof a[0])
            e.prototype.saveCanvas(b, a[0]);
          else {
            var d = c(a[1], a[2])[1];
            switch (d) {
              case "json":
                return void e.prototype.saveJSON(a[0], a[1], a[2]);
              case "txt":
                return void e.prototype.saveStrings(a[0], a[1], a[2]);
              default:
                a[0] instanceof Array
                  ? e.prototype.saveStrings(a[0], a[1], a[2])
                  : a[0] instanceof e.Table
                  ? e.prototype.saveTable(a[0], a[1], a[2], a[3])
                  : a[0] instanceof e.Image
                  ? e.prototype.saveCanvas(a[0].canvas, a[1])
                  : a[0] instanceof e.SoundFile &&
                    e.prototype.saveSound(a[0], a[1], a[2], a[3]);
            }
          }
        }),
        ...
        (e.prototype.saveJSONObject = e.prototype.saveJSON),
        (e.prototype.saveJSONArray = e.prototype.saveJSON),
        (e.prototype.saveStream = function() {
          throw "not yet implemented";
        }),
          ...
          if (("tsv" === c && (g = "	"), "html" !== c)) {
            if ("0" !== e[0])
              for (var h = 0; h < e.length; h++)
                h < e.length - 1 ? d.print(e[h] + g) : d.println(e[h]);
            for (var i = 0; i < a.rows.length; i++) {
              var j;
              for (j = 0; j < a.rows[i].arr.length; j++)
                j < a.rows[i].arr.length - 1
                  ? d.print(a.rows[i].arr[j] + g)
                  : i < a.rows.length - 1
                  ? d.println(a.rows[i].arr[j])
                  : d.print(a.rows[i].arr[j]);
            }
          } else {
      ...
      return (
        ...
        (e.prototype._checkFileExtension = c),
        (e.prototype._isSafari = function() {
    ...
    (amdclean.outputimage = (function(a, b) {
      "use strict";
      var c = b,
        d = [];
      return (
        (c.prototype.saveCanvas = function(a, b, d) {
          d ||
            ((d = c.prototype._checkFileExtension(b, d)[1]),
            "" === d && (d = "png"));
          var e;
          if (
            (a
            ...
            (f += "Now capturing a screenshot...\n"),
              ...
              alert(f),
              (window.location.href = e.toDataURL());
          } else {
            var g;
    ...
    (amdclean.outputtext_area = (function(a, b) {
      "use strict";
      var c = b;
      return (
        (c.prototype.print =
          window.console && console.log
            ...
            : function() {}),
        (c.prototype.println = c.prototype.print),
        c
      );
    })({}, amdclean.core)),
    (amdclean.renderingrendering = (function(a, b, c) {
      var d = b,
        c = c;
      return (
        (d.prototype.createCanvas = function(a, b, c) {
          ...
          return (
            c
              ...
              : (e = this.canvas),
            this._setupDone ||
              ((e.className += " p5_hidden"), (e.style.visibility = "hidden")),
            this._userNode
              ? this._userNode.appendChild(e)
              : document.body.appendChild(e),
            this._defaultGraphics ||
              ((this._defaultGraphics = new d.Graphics(e, this, !0)),
              this._elements.push(this._defaultGraphics)),
            this._defaultGraphics.resize(a, b),
        ...
        (d.prototype.createGraphics = function(a, b) {
          ...
          for (var g in d.prototype)
            f.hasOwnProperty(g) ||
              (f[g] =
                "function" == typeof d.prototype[g]
                  ? d.prototype[g].bind(f)
                  : d.prototype[g]);
    ...
    (amdclean.shape2d_primitives = (function(a, b, c, d) {
      "use strict";
      function e(a, b, c) {
        for (
          var d = 2 * Math.PI,
      ...
      var g = b,
        ...
        h = 1e-5;
      return (
        (g.prototype.arc = function(a, b, f, g, h, i, j) {
          if (this._doStroke || this._doFill) {
            this._angleMode === d.DEGREES &&
              ((h = this.radians(h)), (i = this.radians(i)));
            ...
            return (
              ...
              m.forEach(function(a, b) {
                0 === b && k.moveTo(l.x + a.x1 * n, l.y + a.y1 * o),
                  k.bezierCurveTo(
                    l.x + a.x2 * n,
                    l.y + a.y2 * o,
                    l.x + a.x3 * n,
              ...
              this._doFill &&
              ((j === d.PIE || null == j) && k.lineTo(l.x, l.y),
              k.closePath(),
              k.fill(),
              this._doStroke && (j === d.CHORD || j === d.PIE))
                ? (k.stroke(), this)
                : (this._doStroke &&
                    (j === d.OPEN || null == j) &&
                    (k.beginPath(),
        ...
        (g.prototype.ellipse = function(a, b, d, e) {
          if (this._doStroke || this._doFill) {
            ...
            if ((f.beginPath(), d === e))
              f.arc(g.x + g.w / 2, g.y + g.w / 2, g.w / 2, 0, 2 * Math.PI, !1);
            else {
              var h = 0.5522848,
                i = (g.w / 2) * h,
                j = (g.h / 2) * h,
                ...
                n = g.y + g.h / 2;
              f.moveTo(g.x, n),
                f.bezierCurveTo(g.x, n - j, m - i, g.y, m, g.y),
                f.bezierCurveTo(m + i, g.y, k, n - j, k, n),
                f.bezierCurveTo(k, n + j, m + i, l, m, l),
                f.bezierCurveTo(m - i, l, g.x, n + j, g.x, n),
                f.closePath();
            }
        ...
        (g.prototype.line = function(a, b, c, d) {
          if (this._doStroke) {
            ...
            if ("rgba(0,0,0,0)" !== e.strokeStyle)
              return (
                e.beginPath(), e.moveTo(a, b), e.lineTo(c, d), e.stroke(), this
              );
          }
        }),
          ...
          if (this._doStroke) {
            ...
            if ("rgba(0,0,0,0)" !== e)
              return (
                ...
                c.lineWidth > 1
                  ? (c.beginPath(),
                    c.arc(a, b, c.lineWidth / 2, 0, d.TWO_PI, !1),
                    c.fill())
                  : c.fillRect(a, b, 1, 1),
                (c.fillStyle = f),
                this
        ...
        (g.prototype.quad = function(a, b, c, d, e, f, g, h) {
          if (this._doStroke || this._doFill) {
            ...
            return (
              ...
              i.closePath(),
              this._doFill && i.fill(),
              this._doStroke && i.stroke(),
              this
            );
          }
        }),
        (g.prototype.rect = function(a, b, d, e, f, g, h, i) {
          if (this._doStroke || this._doFill) {
            var j = c.modeAdjust(a, b, d, e, this._rectMode),
              k = this.drawingContext;
            if (
              (this._doStroke && k.lineWidth % 2 === 1 && k.translate(0.5, 0.5),
              k.beginPath(),
              "undefined" == typeof f)
            )
              k.rect(j.x, j.y, j.w, j.h);
            else {
              "undefined" == typeof g && (g = f),
                "undefined" == typeof h && (h = g),
                "undefined" == typeof i && (i = h);
              var l = j.x,
                m = j.y,
                n = j.w,
                o = j.h,
              ...
              2 * f > n && (f = p),
                ...
                k.beginPath(),
                k.moveTo(l + f, m),
                k.arcTo(l + n, m, l + n, m + o, g),
                k.arcTo(l + n, m + o, l, m + o, h),
                k.arcTo(l, m + o, l, m, i),
                k.arcTo(l, m, l + n, m, f),
                k.closePath();
            }
    ...
    (amdclean.shapeattributes = (function(a, b, c) {
      "use strict";
      var d = b,
        c = c;
      return (
        (d.prototype._rectMode = c.CORNER),
        (d.prototype._ellipseMode = c.CENTER),
        ...
        (d.prototype.strokeCap = function(a) {
          return (
            (a === c.ROUND || a === c.SQUARE || a === c.PROJECT) &&
    ...
    (amdclean.shapecurves = (function(a, b) {
      "use strict";
      var c = b,
        d = 20,
        e = 20;
      return (
        (c.prototype._curveTightness = 0),
        (c.prototype.bezier = function(a, b, c, d, e, f, g, h) {
          return this._doStroke
            ? (this.beginShape(),
              this.vertex(a, b),
              this.bezierVertex(c, d, e, f, g, h),
              this.endShape(),
              this.stroke(),
              this)
            : void 0;
        ...
        (c.prototype.curve = function(a, b, c, d, e, f, g, h) {
          return this._doStroke
            ? (this.beginShape(),
              this.curveVertex(a, b),
              this.curveVertex(c, d),
              this.curveVertex(e, f),
              this.curveVertex(g, h),
              this.endShape(),
              this.stroke(),
              this)
            : void 0;
    ...
    (amdclean.shapevertex = (function(a, b, c) {
      "use strict";
      var d = b,
        c = c,
        e = null,
        ...
        k = !1;
      return (
        (d.prototype._doFillStrokeClose = function() {
        ...
        (d.prototype.endShape = function(a) {
          ...
          if (!i || (e !== c.POLYGON && null !== e))
            if (!h || (e !== c.POLYGON && null !== e))
              if (!j || (e !== c.POLYGON && null !== e))
                if (e === c.POINTS)
                  for (g = 0; m > g; g++)
                    (b = f[g]),
                      this._doStroke && this.stroke(b[6]),
                      this.point(b[0], b[1]);
                else if (e === c.LINES)
                  for (g = 0; m > g + 1; g += 2)
                    (b = f[g]),
                      this._doStroke && this.stroke(f[g + 1][6]),
                      this.line(b[0], b[1], f[g + 1][0], f[g + 1][1]);
                else if (e === c.TRIANGLES)
                  for (g = 0; m > g + 2; g += 3)
                    (b = f[g]),
                      this.drawingContext.beginPath(),
                      this.drawingContext.moveTo(b[0], b[1]),
                      this.drawingContext.lineTo(f[g + 1][0], f[g + 1][1]),
                      this.drawingContext.lineTo(f[g + 2][0], f[g + 2][1]),
                      this.drawingContext.lineTo(b[0], b[1]),
                      this._doFill &&
                        (this.fill(f[g + 2][5]), this.drawingContext.fill()),
                      this._doStroke &&
                        (this.stroke(f[g + 2][6]),
                  ...
                  for (g = 0; m > g + 1; g++)
                    (b = f[g]),
                      this.drawingContext.beginPath(),
                      this.drawingContext.moveTo(f[g + 1][0], f[g + 1][1]),
                      this.drawingContext.lineTo(b[0], b[1]),
                      this._doStroke && this.stroke(f[g + 1][6]),
                      this._doFill && this.fill(f[g + 1][5]),
                      m > g + 2 &&
                        (this.drawingContext.lineTo(f[g + 2][0], f[g + 2][1]),
                        this._doStroke && this.stroke(f[g + 2][6]),
                        this._doFill && this.fill(f[g + 2][5])),
                      this._doFillStrokeClose();
                else if (e === c.TRIANGLE_FAN) {
                  if (m > 2)
                    for (
                      this.drawingContext.beginPath(),
                        this.drawingContext.moveTo(f[0][0], f[0][1]),
                        this.drawingContext.lineTo(f[1][0], f[1][1]),
                        this.drawingContext.lineTo(f[2][0], f[2][1]),
                        this._doFill && this.fill(f[2][5]),
                        this._doStroke && this.stroke(f[2][6]),
                        this._doFillStrokeClose(),
                        g = 3;
                      m > g;
                      g++
                  ...
                  for (g = 0; m > g + 3; g += 4) {
                    for (
                      ...
                      this.drawingContext.lineTo(f[g + l][0], f[g + l][1]);
                    this.drawingContext.lineTo(b[0], b[1]),
                      this._doFill && this.fill(f[g + 3][5]),
                      this._doStroke && this.stroke(f[g + 3][6]),
                      this._doFillStrokeClose();
                  }
                ...
                for (this.drawingContext.beginPath(), g = 0; m > g; g++)
                  f[g].isVert
                    ? f[g].moveTo
                      ? this.drawingContext.moveTo([0], f[g][1])
                      : this.drawingContext.lineTo(f[g][0], f[g][1])
              ...
              for (this.drawingContext.beginPath(), g = 0; m > g; g++)
                f[g].isVert
                  ? f[g].moveTo
                    ? this.drawingContext.moveTo(f[g][0], f[g][1])
                    : this.drawingContext.lineTo(f[g][0], f[g][1])
            ...
            for (
              this.drawingContext.beginPath(),
                this.drawingContext.moveTo(f[1][0], f[1][1]),
                g = 1;
              m > g + 2;
              g++
            )
              (b = f[g]),
                (n[0] = [b[0], b[1]]),
                (n[1] = [
                  b[0] + (o * f[g + 1][0] - o * f[g - 1][0]) / 6,
                  b[1] + (o * f[g + 1][1] - o * f[g - 1][1]) / 6
                ]),
                (n[2] = [
                  f[g + 1][0] + (o * f[g][0] - o * f[g + 2][0]) / 6,
                  f[g + 1][1] + (o * f[g][1] - o * f[g + 2][1]) / 6
                ]),
                (n[3] = [f[g + 1][0], f[g + 1][1]]),
                this.drawingContext.bezierCurveTo(
                  n[1][0],
            ...
            d && this.drawingContext.lineTo(f[g + 1][0], f[g + 1][1]),
              this._doFillStrokeClose();
          }
        ...
        (d.prototype.vertex = function(a, b, c) {
          ...
          return (
            ...
            (d[3] = 0),
            (d[4] = 0),
            (d[5] = this.drawingContext.fillStyle),
            (d[6] = this.drawingContext.strokeStyle),
            c && (d.moveTo = c),
            k ? (0 === g.length && (d.moveTo = !0), g.push(d)) : f.push(d),
            this
          );
        }),
        d
    ...
    (amdclean.structure = (function(a, b) {
      "use strict";
      var c = b;
      return (
        ...
        (c.prototype.pop = function() {
          ...
          (this._doStroke = a.doStroke),
            (this._doFill = a.doFill),
            (this._tint = a.tint),
            (this._imageMode = a.imageMode),
            (this._rectMode = a.rectMode),
            (this._ellipseMode = a.ellipseMode),
            (this._colorMode = a.colorMode),
            (this.textFont = a.textFont),
            (this.textLeading = a.textLeading),
        ...
        (c.prototype.redraw = function() {
          ...
          "function" == typeof b &&
            ...
            this._registeredMethods.pre.forEach(function(a) {
              a.call(this);
            }),
            b(),
            this._registeredMethods.post.forEach(function(a) {
              a.call(this);
            }),
            this.pop());
        }),
    ...
    (amdclean.transform = (function(a, b, c) {
      "use strict";
      var d = b,
        c = c;
      return (
        ...
        (d.prototype.rotate = function(a) {
          return (
            this._angleMode === c.DEGREES && (a = this.radians(a)),
        ...
        (d.prototype.shearX = function(a) {
          return (
            this._angleMode === c.DEGREES && (a = this.radians(a)),
            this.drawingContext.transform(1, 0, this.tan(a), 1, 0, 0),
            this
          );
        }),
        (d.prototype.shearY = function(a) {
          return (
            this._angleMode === c.DEGREES && (a = this.radians(a)),
            this.drawingContext.transform(1, this.tan(a), 0, 1, 0, 0),
            this
          );
        }),
    ...
    (amdclean.typographyattributes = (function(a, b, c) {
      "use strict";
      var d = b,
        c = c;
      return (
        (d.prototype._textLeading = 15),
        (d.prototype._textFont = "sans-serif"),
        (d.prototype._textSize = 12),
        (d.prototype._textStyle = c.NORMAL),
        (d.prototype._textAscent = null),
        (d.prototype._textDescent = null),
        (d.prototype.textAlign = function(a, b) {
          (a === c.LEFT || a === c.RIGHT || a === c.CENTER) &&
        ...
        (d.prototype.textSize = function(a) {
          this._setProperty("_textSize", a),
            this._setProperty("_textLeading", 1.25 * a),
            this._applyTextProperties();
        }),
        (d.prototype.textStyle = function(a) {
          (a === c.NORMAL || a === c.ITALIC || a === c.BOLD) &&
            (this._setProperty("_textStyle", a), this._applyTextProperties());
        }),
        ...
        (d.prototype._applyTextProperties = function() {
          ...
          var a =
            this._textStyle + " " + this._textSize + "px " + this._textFont;
        ...
        (d.prototype._updateTextMetrics = function() {
          ...
          (b.style.verticalAlign = "bottom"),
            (d = this._calculateOffset(b)),
            (e = this._calculateOffset(a));
          var g = d[1] - e[1],
            h = g - f;
          document.body.removeChild(c),
            this._setProperty("_textAscent", f),
    ...
    (amdclean.typographyloading_displaying = (function(a, b) {
      "use strict";
      var c = b;
      return (
        (c.prototype.text = function(a, b, c, d, e) {
          "string" != typeof a && (a = a.toString()),
            "undefined" != typeof d && ((c += this._textLeading), (e += c)),
            (a = a.replace(/(\t)/g, "  "));
          for (var f = a.split("\n"), g = 0; g < f.length; g++) {
            for (var h = "", i = f[g].split(" "), j = 0; j < i.length; j++)
              if (c + this._textLeading <= e || "undefined" == typeof e) {
                var k = h + i[j] + " ",
                  ...
                  m = l.width;
                "undefined" != typeof d && m > d
                  ? (this._doFill && this.drawingContext.fillText(h, b, c),
                    this._doStroke && this.drawingContext.strokeText(h, b, c),
                    (h = i[j] + " "),
                    (c += this._textLeading))
                  : (h = k);
              }
    ...
    (amdclean.src_app = (function(a, b) {
      ...
      amdclean.colorsetting,
      amdclean.constants,
      amdclean.dataconversion,
      amdclean.dataarray_functions,
      amdclean.datastring_functions,
      amdclean.environment,
      amdclean.imageimage,
      amdclean.imageloading_displaying,
      amdclean.imagepixels,
      amdclean.inputfiles,
      amdclean.inputkeyboard,
      amdclean.inputacceleration,
      amdclean.inputmouse,
      amdclean.inputtime_date,
      amdclean.inputtouch,
      amdclean.mathmath,
      amdclean.mathcalculation,
      amdclean.mathrandom,
      amdclean.mathnoise,
      amdclean.mathtrigonometry,
      amdclean.outputfiles,
      amdclean.outputimage,
      amdclean.outputtext_area,
      amdclean.renderingrendering,
      amdclean.shape2d_primitives,
      amdclean.shapeattributes,
      amdclean.shapecurves,
      amdclean.shapevertex,
      amdclean.structure,
      amdclean.transform,
      amdclean.typographyattributes,
      amdclean.typographyloading_displaying
    )),
    amdclean.src_app
  );
});
